...
function multiply(a, b) { //eslint-disable-line
  ...
  let multiplySolution = [total, message];
...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  ...
  let sumAndMultiplySolution = [sumTotal, productTotal, sumMessage, productMessage];
  return sumAndMultiplySolution;
}
